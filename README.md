...
| --- | --- | ---
| **`a1vy`** | [🤖 I help development by doing things](./packages/a1vy#readme) | [![0.0.75](https://img.shields.io/npm/v/a1vy.svg)](https://www.npmjs.com/package/a1vy)
...
| **`@recursive/assign`** | [Recursive assign for objects, arrays and more](./packages/assign#readme) | [![1.2.4](https://img.shields.io/npm/v/@recursive/assign.svg)](https://www.npmjs.com/package/@recursive/assign)
...
| **`chunkalyse`** | [🍰 Summarise webpack stats output file](./packages/chunkalyse#readme) | [![0.5.3](https://img.shields.io/npm/v/chunkalyse.svg)](https://www.npmjs.com/package/chunkalyse)
...
| **`create-git-alias`** | [👨🏻 - interactively apply useful git aliases](./packages/create-git-alias#readme) | [![1.1.2](https://img.shields.io/npm/v/create-git-alias.svg)](https://www.npmjs.com/package/create-git-alias)
...
| **`edit-package`** | [Read, write and reset package.json](./packages/edit-package#readme) | [![1.0.2](https://img.shields.io/npm/v/edit-package.svg)](https://www.npmjs.com/package/edit-package)
...
| **`eslint-plugin-log`** | [👕 ESLint plugin: log the paths of all files being linted](./packages/eslint-plugin-log#readme) | [![1.2.2](https://img.shields.io/npm/v/eslint-plugin-log.svg)](https://www.npmjs.com/package/eslint-plugin-log)
